...
#include "FastSimulation/HadShowerTuning/include/TrackInformation.h"
...
void SteppingAction::UserSteppingAction(const G4Step * g4Step){
    ...
    if(g4Step->GetTrack()->GetTrackID()==1 && g4Step->IsLastStepInVolume() && g4Step->GetPostStepPoint() && g4Step->GetPostStepPoint()->GetPhysicalVolume())
    {
